...
import ManageWorkDaysSection from '../../../../components/section/foodSellerList/editFoodList/manageWorkDays'
import '../../../../components/styles/dashboard-styles/styles.css'

export default function ManageWorkDaysPage() {
