...
export default function Payout() {
  return(
    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
       <div className='pay-container' style={{ width: '850px', height: '60%', right: '50px', border: '1px groove', marginLeft:'-20px', marginTop:'45px' }}>
...
{/*Credit Card*/}
<div className='custom-credit' style={{ width: '850px', height: '90%', right: '20px', border: '1px groove', marginLeft:'-20px', marginTop:'50px' }}>
